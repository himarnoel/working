    ...
    <div className='w-full grid grid-cols-1 md:grid-cols-2 justify-items-center place-items-center gap-y-[36px] lg:gap-y-[56px] gap-x-[16px]'>
        {
            services.slice(1,).map((service, index) => (
                <div key={index} className='p-[24px] lg:p-[36px] rounded-[16px] lg:rounded-[24px] w-[340px] md:w-full lg:w-[640px] h-[480px] lg:h-[660px] bg-grayTen flex flex-col justify-between items-start gap-[16px]'>
