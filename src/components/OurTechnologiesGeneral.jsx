...
const OurTechnologiesGeneral = ({tech, techTitle}) => {
  return (
    <section className='pt-[160px] pb-[120px] lg:py-[160px] xl:px-[54px] gap-[48px] xl:gap-[80px] flex flex-col justify-center items-center w-full bg-grayThree'>
        ...
        <div className='w-full xl:max-w-[1320px] mx-auto py-[150px] px-[76px] xl:rounded-[40px] bg-blue h-full xl:h-[3300px] grid grid-cols-1 md:grid-cols-2 justify-items-center place-items-center gap-[40px] lg:gap-y-[40px] lg:gap-x-[24px]'>
            {
                tech.map((t) => (
                    <div key={t.id} className='border border-blueFive bg-blueSix gap-[24px] lg:gap-[16px] py-[30px] lg:py-[40px] xl:py-[64px] px-[16px] xl:px-[24px] 2xl:px-[30px] rounded-[16px] w-[328px] md:w-full h-full xl:h-[740px] flex flex-col justify-between items-start font-instrument'>
