...
const OurTechnologiesGeneral = ({tech, techTitle}) => {
  ...
  return (
    <section className='pt-[160px] pb-[120px] lg:py-[160px] xl:px-[54px] gap-[48px] xl:gap-[80px] flex flex-col justify-center items-center w-full bg-grayThree'>
        <h1 className={`w-[207px] ${pathname === '/front-end' ? 'lg:w-[370px]' : 'lg:w-[915px]'} gap-[16px] flex justify-center items-center text-center text-blue font-bold leading-10 lg:leading-[67.2px] text-[2rem] lg:text-[3.5rem]`}>{techTitle}</h1>
