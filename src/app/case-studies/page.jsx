            ...
            <div className='max-w-[1200px] mx-auto grid grid-cols-1 md:grid-cols-2 justify-items-center place-items-center gap-x-[32px] gap-y-[104px]'>
                {
                    cases.map((caseItem, index) => (
                        <div key={index} className='bg-white w-full xl:w-[584px] h-[516px] pb-[16px] md:pb-[32px] gap-[32px] flex flex-col justify-center items-start rounded-bl-[16px] rounded-br-[16px]'>
