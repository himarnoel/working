  ...
  return (
    <section className="w-full min-h-screen lg:h-[980px] relative flex justify-center items-start font-instrument">
        ...
        <div className='gap-[20px] max-w-[1079px] mx-auto px-[24px] md:px-[44px] relative z-10 mt-[170px] lg:mt-[190px] flex flex-col justify-center items-center'>
            <h1 className='w-[328px] md:w-[991px] flex justify-center items-center text-center gap-[24px] font-bold text-[2.25rem] md:text-[3.5rem] leading-[43.2px] md:leading-[67.2px] text-white'>
                Building Digital Ecosystems: Empowering Global Growth and Innovation
            </h1>
            <p className='w-[328px] md:w-[893px] flex justify-center items-center text-center text-grayThree text-[.875rem] md:text-[1.25rem] font-normal leading-[19.6px] md:leading-[35px] font-manrope'>
