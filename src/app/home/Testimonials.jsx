  ...
  return (
    <section className='bg-white gap-[96px] py-[120px] px-[46px] flex flex-col justify-center items-center'>
        ...
        <div className='max-w-[1296px] mx-auto gap-[8px] grid grid-cols-1 md:grid-cols-2 xl:flex xl:justify-between xl:items-center justify-items-center place-items-center min-h-[480px]'>
            ...
            <div className='bg-gray w-[328px] lg:w-[360px] xl:w-[500px] 2xl:w-[560px] md:h-[480px] rounded-[12px] flex flex-col justify-between items-start px-[20px] py-[45px]'>
                <div className='w-full flex flex-col justify-center items-start gap-[20px]'>
                    ...
                    <p className='font-normal leading-[22.5px] text-[0.938rem] text-blueTwo font-instrument xl:w-[480px]'>Through innovative technology and strategic partnerships, we have helped our clients achieve remarkable results in financial inclusion and customer engagement.
                    </p>
                </div>
                <div className='flex justify-center items-center gap-[12px] w-[266px] p-[14px]'>
